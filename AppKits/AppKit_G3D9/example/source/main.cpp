...
int main(int argc, char** argv)
{
	...
	MinVR::DataFileUtils::addFileSearchPath("$(G)/src/MinVR-git/MinVR/MVRCore/vrsetup");
	MinVR::DataFileUtils::addFileSearchPath("$(G)/src/MinVR-git/MinVR/MVRCore/shaders");
