...
public:
    ...
    inline Color4 max(const Color4& other) const {
        return Color4(G3DLite::max(r, other.r), G3DLite::max(g, other.g), G3DLite::max(b, other.b), G3DLite::max(a, other.a));
    }

    inline Color4 min(const Color4& other) const {
        return Color4(G3DLite::min(r, other.r), G3DLite::min(g, other.g), G3DLite::min(b, other.b), G3DLite::min(a, other.a));
    }
    ...
    inline bool isFinite() const {
        return G3DLite::isFinite(r) && G3DLite::isFinite(g) && G3DLite::isFinite(b) && G3DLite::isFinite(a);
    }
...
inline bool Color4::fuzzyEq(const Color4& other) const {
    ...
    return G3DLite::fuzzyEq(dif.r * dif.r + dif.g * dif.g + dif.b * dif.b + dif.a * dif.a, 0);
}
...
inline bool Color4::fuzzyNe(const Color4& other) const {
    Color4 dif = (*this - other);
    return G3DLite::fuzzyNe(dif.r * dif.r + dif.g * dif.g + dif.b * dif.b + dif.a * dif.a, 0);
}
...
struct HashTrait<G3DLite::Color4> {
    static size_t hashCode(const G3DLite::Color4& key) {
        return key.hashCode();
    }
};
