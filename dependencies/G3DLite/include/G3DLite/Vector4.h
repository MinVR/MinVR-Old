...
inline Vector4 Vector4::min(const Vector4 &v) const {
    return Vector4(G3DLite::min(v.x, x), G3DLite::min(v.y, y), G3DLite::min(v.z, z), G3DLite::min(v.w, w));
}

//----------------------------------------------------------------------------
inline Vector4 Vector4::max(const Vector4 &v) const {
    return Vector4(G3DLite::max(v.x, x), G3DLite::max(v.y, y), G3DLite::max(v.z, z), G3DLite::max(v.w, w));
}
...
inline bool Vector4::isFinite() const {
    return G3DLite::isFinite(x) && G3DLite::isFinite(y) && G3DLite::isFinite(z) && G3DLite::isFinite(w);
}
