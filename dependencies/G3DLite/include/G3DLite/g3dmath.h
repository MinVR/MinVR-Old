...
/** 
    ...
    G3DLite::isNan() and G3DLite::isFinite() will return reliable results. */
double inf();
...
inline bool isFinite(double x) {
    return ! isNaN(x) && (x < G3DLite::inf()) && (x > -G3DLite::inf());
}

inline bool isFinite(float x) {
    return ! isNaN(x) && (x < G3DLite::finf()) && (x > -G3DLite::finf());
}
