...
#ifndef G3DLITE_Ray_h
#define G3DLITE_Ray_h
...
public:
    ...
    */
    ...
    /**
     ...
     See also the G3DLite::CollisionDetection "movingPoint" methods,
    ...
    /** Refracts about the normal
        using G3DLite::Vector3::refractionDirection
    ...
    /** Reflects about the normal
        using G3DLite::Vector3::reflectionDirection
