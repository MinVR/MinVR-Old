...
public:
    ...
    inline G3DLite::int32& operator[] (int i) {
        debugAssert(i <= 2);
        return ((G3DLite::int32*)this)[i];
    }

    inline const G3DLite::int32& operator[] (int i) const {
        debugAssert(i <= 2);
        return ((G3DLite::int32*)this)[i];
    }
...
template <> struct HashTrait<G3DLite::Vector3int32> {
    static size_t hashCode(const G3DLite::Vector3int32& key) {
        ...
        const G3DLite::uint32 top = (1UL << 31);
        // Mask for the bottom 10 bits of a uint32
        const G3DLite::uint32 bot = 0x000003FF;
