...
public:
    ...
    inline Color3 max(const Color3& other) const {
        return Color3(G3DLite::max(r, other.r), G3DLite::max(g, other.g), G3DLite::max(b, other.b));
    }

    inline Color3 min(const Color3& other) const {
        return Color3(G3DLite::min(r, other.r), G3DLite::min(g, other.g), G3DLite::min(b, other.b));
    }

    /** Smallest element */
    inline float min() const {
        return G3DLite::min(G3DLite::min(r, g), b);
    }

    /** Largest element */
    inline float max() const {
        return G3DLite::max(G3DLite::max(r, g), b);
    }
...
inline G3DLite::Color3 operator* (float s, const G3DLite::Color3& c) {
    return c * s;
}

inline G3DLite::Color3 operator* (G3DLite::Color1& s, const G3DLite::Color3& c) {
    return c * s.value;
}

inline G3DLite::Color3 operator* (const G3DLite::Color3& c, G3DLite::Color1& s) {
    return c * s.value;
}
...
inline bool Color3::fuzzyEq(const Color3& other) const {
    return G3DLite::fuzzyEq((*this - other).squaredLength(), 0);
}

//----------------------------------------------------------------------------

inline bool Color3::fuzzyNe(const Color3& other) const {
    return G3DLite::fuzzyNe((*this - other).squaredLength(), 0);
}
...
template <> struct HashTrait<G3DLite::Color3> {
    static size_t hashCode(const G3DLite::Color3& key) {
        return key.hashCode();
    }
};
