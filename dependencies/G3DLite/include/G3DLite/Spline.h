...
/** Common implementation code for all G3DLite::Spline template parameters */
class SplineBase {
public:
...
/**
 ...
 be used; you can make splines out of G3DLite::Vector4, G3DLite::Matrix3, or
 your own classes.

 To provide shortest-path interpolation, subclass G3DLite::Spline and
