...
/**
   ...
   returns.
   @sa G3DLite::logPrintf, G3DLite::screenPrintf
...
/**
   ...
   Also sends output to the console (G3DLite::consolePrintf) if there is a consolePrintHook,
   and log (G3DLite::logPrintf), and flushes before returning.   
