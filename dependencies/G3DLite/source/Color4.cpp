...
const Color4& Color4::inf() {
    static Color4 c((float)G3DLite::finf(), (float)G3DLite::finf(), (float)G3DLite::finf(), (float)G3DLite::finf());
    return c;
}


const Color4& Color4::nan() {
    static Color4 c((float)G3DLite::fnan(), (float)G3DLite::fnan(), (float)G3DLite::fnan(), (float)G3DLite::fnan());
    return c;
}
...
std::string Color4::toString() const {
    return G3DLite::format("(%g, %g, %g, %g)", r, g, b, a);
}
