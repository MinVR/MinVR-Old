...
const Vector4& Vector4::inf() { 
    static const Vector4 v((float)G3DLite::finf(), (float)G3DLite::finf(), (float)G3DLite::finf(), (float)G3DLite::finf()); 
    return v; 
}
...
const Vector4& Vector4::nan() { 
    static Vector4 v((float)G3DLite::fnan(), (float)G3DLite::fnan(), (float)G3DLite::fnan(), (float)G3DLite::fnan()); 
    return v; 
}
...
std::string Vector4::toString() const {
    return G3DLite::format("(%g, %g, %g, %g)", x, y, z, w);
}
// 2-char swizzles
