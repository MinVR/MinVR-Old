...
const Vector2& Vector2::inf() { 
	static Vector2 v((float)G3DLite::finf(), (float)G3DLite::finf());
	return v; 
}


const Vector2& Vector2::nan() { 
	static Vector2 v((float)G3DLite::fnan(), (float)G3DLite::fnan()); 
	return v; 
}
...
Vector2 Vector2::random(G3DLite::Random& r) {
    Vector2 result;
