...
// Uncomment the following line to turn off G3DLite::System memory
...
void System::memset(void* dst, uint8 value, size_t numBytes) {
    ...
    uint32 v = value;
    v = v + (v << 8) + (v << 16) + (v << 24); 
    G3DLite::memfill(dst, v, numBytes);
#else
...
void System::initTime() {
        ...
        m_realWorldGetTickTime0 = (RealTime)t.time - t.timezone * G3DLite::MINUTE + (t.dstflag ? G3DLite::HOUR : 0);
